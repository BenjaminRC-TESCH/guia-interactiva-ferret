...
// Props
type Props = {
    listings: ListingTypeParking[];
};

// Función para obtener el link
const getLinkForJef = (item: any) => {
    return { pathname: `/listing/parking/[parkingId]`, params: { parkingId: item.id } };
};

const ListingParkings = ({ listings }: Props) => {
    const renderItems: ListRenderItem<ListingTypeParking> = ({ item }) => {
...
export default ListingParkings;
