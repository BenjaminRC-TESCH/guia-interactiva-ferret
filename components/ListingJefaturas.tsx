...
// Props
type Props = {
    listings: ListingTypeJefatura[];
};

// Función para obtener el link
const getLinkForJef = (item: any) => {
    return { pathname: `/listing/head/[headDetailsId]`, params: { jefaturaId: item.id } };
};

const ListingJefaturas = ({ listings }: Props) => {
    const renderItems: ListRenderItem<ListingTypeJefatura> = ({ item }) => {
...
export default ListingJefaturas;
